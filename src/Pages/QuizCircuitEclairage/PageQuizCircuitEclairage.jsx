...
import { ContentQuizEclairage } from "../../Data/ContentQuiz/ContentQuizEclairage/ContentQuizEclairage.jsx";
...
function PageQuizCircuitEclairage() {
  ...
  let numberTotalQuestion = ContentQuizEclairage.length;
  ...
  function storeInLocalStorage(updateValue) {
    arrayUserResponses = getFromLocalStorge(
      "userResponsesQuizCircuitEclairage"
    );
  ...
  function InitQuiz() {
    ...
    if (!localStorage.getItem("userResponsesQuizCircuitEclairage")) {
      arrayUserResponses = [];
  ...
  function valideResponse() {
    ...
    let finalScore = calulateFinalScore("userResponsesQuizCircuitEclairage");

    disabledAllInputs();
    displayScore(finalScore);
    setMessageError(false);
    deleteElementInLocalStorage("userResponsesQuizCircuitEclairage");
    setisvalid(true);
  ...
  function resetQuiz(e) {
    e.preventDefault();
    localStorage.removeItem("userResponsesQuizCircuitEclairage");
...
export { PageQuizCircuitEclairage };
